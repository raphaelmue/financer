...
class CatmullRom {
    ...
    // ******************** Constructors **************************************
    CatmullRom(final Point2D p0, final Point2D p1, final Point2D p2, final Point2D p3) {
    ...
    static class CatmullRomSpline {
        ...
        // ******************** Constructors **************************************
        CatmullRomSpline(final double P0, final double P1, final double P2, final double P3) {
            p0 = P0;
            p1 = P1;
            p2 = P2;
            p3 = P3;
