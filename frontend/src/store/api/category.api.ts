...
export const categoryActionCreators: ActionCreatorsMapObject = {
    dispatchLoadCategories: loadCategories
};

export const categoryDispatchMap = (dispatch: Dispatch) => bindActionCreators(categoryActionCreators, dispatch);
