...
RUN cd backend/ && mvn verify -DskipTests -P generate-openapi-specification
...
RUN java -jar /opt/openapi-generator/modules/openapi-generator-cli/target/openapi-generator-cli.jar generate -i financer.openapi.json -g typescript-fetch -o frontend/src/.openapi --additional-properties="typescriptThreePlus=true,ngVersion=6.1.7" --skip-validate-spec
